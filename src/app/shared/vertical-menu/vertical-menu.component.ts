...
export class VerticalMenuComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  level: number = 0;
  // logoUrl = 'assets/img/logos/60px.png';
  logoUrl: string = 'assets/img/icons/30px.png'; // default logo for collapsed state
  expandedLogoUrl: string = 'assets/img/logos/60px.png'; // logo for expanded state
  ...
  loadLayout() {
    ...
    if (this.config.layout.sidebar.backgroundColor === 'white') {
      ...
      this.expandedLogoUrl = 'assets/img/logos/60px.png'; // assuming you have a different logo for expanded state
    } else {
      this.logoUrl = 'assets/img/icons/30px.png';
